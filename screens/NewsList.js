...
export default NewsList = ({navigation}) => {
  ...
  const [selectedId, setSelectedId] = useState(
    'https://www.petrolimex.com.vn/nd/bao-chi-viet-ve-petrolimex-va-xang-dau/xam-pham-nhan-hieu-petrolimex-dang-bao-dong.html',
  );

  const getNews = () => {
    axios
      .get('https://0vd92.sse.codesandbox.io/news/getNews')
      ...
      .catch(function (error) {
        ...
        if (error == 'Error: Network Error') {
          Alert.alert('Lỗi kết nối mạng', 'Vui lòng kiểm tra kết nối mạng', [
